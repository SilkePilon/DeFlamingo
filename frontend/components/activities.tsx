...
const activities = [
  {
    name: "Hiking Trails",
    description: "Explore our scenic hiking trails suitable for all skill levels.",
    image:
  ...
  {
    name: "Bird Watching",
    description: "Observe a wide variety of bird species in their natural habitat.",
    image:
  ...
  return (
    <section id="activities" className="container space-y-16 py-24 md:py-32">
      <div className="mx-auto max-w-[58rem] text-center">
        <h2 className="font-bold text-3xl leading-[1.1] sm:text-3xl md:text-5xl">Our Activities</h2>
        ...
        {activities.map((activity, index) => (
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent p-6 flex flex-col justify-end">
              <h3 className="font-bold text-2xl text-white mb-2">{activity.name}</h3>
