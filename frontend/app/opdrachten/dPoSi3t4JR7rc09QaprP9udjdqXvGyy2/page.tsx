...
export default function PhotoAssignment() {
  ...
  const renderContent = () => {
      ...
      return (
        <Card className="w-full max-w-md">
          <CardHeader>
            ...
            <CardDescription>
              Use your mobile device to complete this assignment
            </CardDescription>
          </CardHeader>
          <CardContent className="flex justify-center">
            <QRCode value="https://outdoorcentrumdeflamlngo.nl/opdrachten/dPoSi3t4JR7rc09QaprP9udjdqXvGyy2" />
          </CardContent>
        </Card>
      );
    }
    ...
    return (
      <Card className="w-full max-w-md">
        <CardHeader>
          <CardTitle>Photo Assignment (2x points)</CardTitle>
          <CardDescription>
            Follow the instructions to complete your assignment
          </CardDescription>
        </CardHeader>
        <CardContent>
          {!cameraActive && !capturedImage && (
            <div className="text-center">
              <p className="mb-4">
                Stand in the same position as shown in the example image:
              </p>
              <div className="relative w-full h-64 mb-4">
                <Image
                  src="https://www.health.com/thmb/7fFFXMLVCzMmhjxfXfs3kTiRS6w=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/HLTH_MoveYourBody_YogaPoses_THUMB-LARGE-726a28603c8043eba44eb9f128f30551.jpg"
                  alt="Example pose"
                  layout="fill"
                  objectFit="contain"
          ...
          {capturedImage && (
            <div className="text-center">
              ...
              {uploadStatus && (
                <p className="mt-4 text-sm font-semibold text-flamingo-500">
                  {uploadStatus}
                </p>
              )}
            </div>
